...
def get_filtering_data(ingre_str):
    ...
    noeat_data = pd.read_csv('../project1/레시피_재료정보.csv', encoding='cp949')
    ...
    # 경로 설정을 해줘야 한다. 중요.....
    df_info = pd.read_csv('../project1/레시피_기본정보.csv', encoding='cp949')
    df_igd = pd.read_csv('../project1/레시피_재료정보.csv', encoding='cp949')
    df_process = pd.read_csv('../project1/레시피_과정정보.csv', encoding='cp949')
...
"""
ingre_str = '-쌀,-금,-새우,-버섯,-멸치,감자,고구마,안심,마늘,계란,콩'
a, b, c = get_filtering_data(ingre_str)
print(a)
print(b)
print(c)
"""